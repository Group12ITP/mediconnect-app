const Header = () => (
  <div className="h-14 bg-white border-b flex items-center px-6 mb-0 justify-between shadow-sm">
    ...
    <div className="flex items-center gap-x-5">
      <div className="flex items-center gap-x-1 text-sm font-medium cursor-pointer">
      ...
      <div className="flex items-center gap-x-2 cursor-pointer">
        <div className="text-right">
          <p className="text-sm font-semibold">Kanchana</p>
          <p className="text-xs text-emerald-600">Patient</p>
        </div>
        <div className="w-8 h-8 bg-emerald-100 text-emerald-700 rounded-2xl flex items-center justify-center font-bold text-lg">K</div>
      </div>
    </div>
  </div>
);
